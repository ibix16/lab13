...
public class FamilyTree
{
    ...
    private static class TreeNode
    {
        ...
        ArrayList<TreeNode> collectAncestorsToList()
        {
            ...
            // "ancestors"  Collect ancestors of this TreeNode into the array list. HINT: going up
	...
	private void addLine(String line) throws Exception
	{
		...
		String childrenString = line.substring(colonIndex+1); // inclusive 
		...
		{
			TreeNode kid = new TreeNode(name);
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		if (node1 == null)
			throw new TreeException("error encountered");
